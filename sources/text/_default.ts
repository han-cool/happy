/**
 * English translations for the D3 AI app
 * Values can be:
...
export const en = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'SmartOSC - D3 AI Platform. Fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
        ...
        supportUsSubtitle: 'Subscribe to Pro features',
        buyMeCoffee: 'Buy Me a Coffee',
        buyMeCoffeeSubtitle: 'Support development with a small donation',
    ...
    settingsFeatures: {
        ...
        supportFeatures: 'Support Options',
        supportFeaturesDescription: 'Control which support and feedback options are shown in the main settings.',
        supportUs: 'Support Us',
        supportUsEnabled: 'Subscription option available',
        supportUsDisabled: 'Subscription option hidden',
        buyMeCoffee: 'Buy Me a Coffee',
        buyMeCoffeeEnabled: 'Donation option available',
        buyMeCoffeeDisabled: 'Donation option hidden',
        sendFeedback: 'Send Feedback',
    ...
    feedback: {
        ...
        selectCategoryFooter: 'Choose the type of feedback you want to send',
        selectCategoryMessage: 'Please select a feedback category',
        enterMessage: 'Enter Message',
        enterMessageMessage: 'Please enter your feedback message',
        message: 'Message',
        messageFooter: 'Describe your feedback in detail. The more information you provide, the better we can help.',
        messagePlaceholder: 'Enter your feedback here...',
        sendFeedback: 'Send Feedback',
        completeForm: 'Please complete all fields to send feedback',
        readyToSend: 'Tap to send your feedback',
        thankYou: 'Thank You!',
        feedbackSentMessage: 'Your feedback has been sent successfully. We appreciate your input!',
        errorSending: 'Error Sending Feedback',
        errorSendingMessage: 'Failed to send feedback. Please try again later.',
        mailNotAvailable: 'Mail Not Available',
        mailNotAvailableMessage: 'Please configure an email account on your device to send feedback.',
        category: 'Category',
    ...
    newSession: {
        ...
        noMachinesFound: 'No machines found. Start a D3 AI session on your computer first.',
        allMachinesOffline: 'All machines appear offline',
        machineOfflineHelp: {
            computerOnline: '• Is your computer online?',
            daemonRunning: '• Is the D3 AI daemon running? Check with `happy daemon status`'
        },
    ...
    server: {
        ...
        notValidD3AIServer: 'Not a valid D3 AI Server',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'D3 AI Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy D3 AI Session ID',
        happySessionId: 'D3 AI Session ID',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Install the D3 AI CLI',
            runIt: 'Run it',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your D3 AI account. This will allow the terminal to send and receive messages securely.',
